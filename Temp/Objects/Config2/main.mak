...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/LiquidControlOfTank.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'Build'   

	@$(AS_GNU_BIN_PATH)/mingw32-make.exe -r -f 'C:/Projects/LiquidControlInTank/Temp/Objects/$(AS_CONFIGURATION)/X20cCP1301/#cpu.mak' -k 
