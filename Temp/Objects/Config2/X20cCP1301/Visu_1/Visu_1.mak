...
$(AS_CPU_PATH)/Visu_1/Cyclic.c.o: \
	$(AS_PROJECT_PATH)/Logical/Visu_1/Cyclic.c \
	...
	$(AS_PROJECT_PATH)/Logical/Visu_1/Variables.var
	@'$(AS_BIN_PATH)/BR.AS.CCompiler.exe' '$(AS_PROJECT_PATH)/Logical/Visu_1/Cyclic.c' -o '$(AS_CPU_PATH)/Visu_1/Cyclic.c.o'  -T SG4  -M IA32  -B E4.34 -G V4.1.2  -s 'Visu_1' -t '$(AS_TEMP_PATH)' -specs=I386specs_brelf -I '$(AS_PROJECT_PATH)/Logical/Visu_1' '$(AS_TEMP_PATH)/Includes/Visu_1' '$(AS_TEMP_PATH)/Includes' -trigraphs -fno-asm -D _DEFAULT_INCLUDES -D _SG4 -fPIC -O0 -g -Wall -include '$(AS_CPU_PATH)/Libraries.h' -x c -P '$(AS_PROJECT_PATH)' -secret '$(AS_PROJECT_PATH)_br.as.ccompiler.exe'

$(AS_CPU_PATH)/Visu_1/Init.c.o: \
	$(AS_PROJECT_PATH)/Logical/Visu_1/Init.c \
	$(AS_PROJECT_PATH)/Logical/Global.var \
	$(AS_PROJECT_PATH)/Logical/Libraries/become/Types.typ \
	$(AS_PROJECT_PATH)/Logical/Libraries/become/become.fun \
	$(AS_PROJECT_PATH)/Logical/Global.typ \
	$(AS_PROJECT_PATH)/Logical/Visu_1/Variables.var
	@'$(AS_BIN_PATH)/BR.AS.CCompiler.exe' '$(AS_PROJECT_PATH)/Logical/Visu_1/Init.c' -o '$(AS_CPU_PATH)/Visu_1/Init.c.o'  -T SG4  -M IA32  -B E4.34 -G V4.1.2  -s 'Visu_1' -t '$(AS_TEMP_PATH)' -specs=I386specs_brelf -I '$(AS_PROJECT_PATH)/Logical/Visu_1' '$(AS_TEMP_PATH)/Includes/Visu_1' '$(AS_TEMP_PATH)/Includes' -trigraphs -fno-asm -D _DEFAULT_INCLUDES -D _SG4 -fPIC -O0 -g -Wall -include '$(AS_CPU_PATH)/Libraries.h' -x c -P '$(AS_PROJECT_PATH)' -secret '$(AS_PROJECT_PATH)_br.as.ccompiler.exe'

$(AS_CPU_PATH)/Visu_1/Exit.c.o: \
	$(AS_PROJECT_PATH)/Logical/Visu_1/Exit.c \
	$(AS_PROJECT_PATH)/Logical/Global.var \
	$(AS_PROJECT_PATH)/Logical/Libraries/become/Types.typ \
	$(AS_PROJECT_PATH)/Logical/Libraries/become/become.fun \
	$(AS_PROJECT_PATH)/Logical/Global.typ \
	$(AS_PROJECT_PATH)/Logical/Visu_1/Variables.var
	@'$(AS_BIN_PATH)/BR.AS.CCompiler.exe' '$(AS_PROJECT_PATH)/Logical/Visu_1/Exit.c' -o '$(AS_CPU_PATH)/Visu_1/Exit.c.o'  -T SG4  -M IA32  -B E4.34 -G V4.1.2  -s 'Visu_1' -t '$(AS_TEMP_PATH)' -specs=I386specs_brelf -I '$(AS_PROJECT_PATH)/Logical/Visu_1' '$(AS_TEMP_PATH)/Includes/Visu_1' '$(AS_TEMP_PATH)/Includes' -trigraphs -fno-asm -D _DEFAULT_INCLUDES -D _SG4 -fPIC -O0 -g -Wall -include '$(AS_CPU_PATH)/Libraries.h' -x c -P '$(AS_PROJECT_PATH)' -secret '$(AS_PROJECT_PATH)_br.as.ccompiler.exe'
...
$(AS_CPU_PATH)/Visu_1/_bur_pvdef.c.o: \
	...
	$(AS_PROJECT_PATH)/Logical/Global.typ \
	$(AS_PROJECT_PATH)/Logical/Visu_1/Variables.var
	@'$(AS_BIN_PATH)/BR.AS.CCompiler.exe' '$(AS_PATH)/AS/GnuInst/V4.1.2/i386-elf/include/bur/_bur_pvdef.c' -o '$(AS_CPU_PATH)/Visu_1/_bur_pvdef.c.o'  -T SG4  -M IA32  -B E4.34 -G V4.1.2  -s 'Visu_1' -t '$(AS_TEMP_PATH)' -specs=I386specs_brelf -I '$(AS_PROJECT_PATH)/Logical/Visu_1' '$(AS_TEMP_PATH)/Includes/Visu_1' '$(AS_TEMP_PATH)/Includes' -trigraphs -fno-asm -D _DEFAULT_INCLUDES -D _SG4 -fPIC -O0 -g -Wall -include '$(AS_CPU_PATH)/Libraries.h' -P '$(AS_PROJECT_PATH)' 
