...
PANEL_HW_SOURCE_Visu1=C:/Projects/LiquidControlInTank/Physical/Config2/Hardware.hw 
DIS_OBJECTS_Visu1=$(PANEL_HW_OBJECT_Visu1) $(KEYMAP_OBJECTS_Visu1)

# KeyMapping flags
$(TEMP_PATH_Visu1)/dis.PS2-Keyboard.vco: $(AS_PROJECT_PATH)/Physical/Config2/X20cCP1301/VC/PS2-Keyboard.dis $(PANEL_HW_SOURCE_Visu1)
	$(VCHWPP) -f '$(PANEL_HW_SOURCE_Visu1)' -o '$(subst .vco,.vci,$(TEMP_PATH_Visu1)/dis.PS2-Keyboard.vco)' -n Visu1 -d Visu1 -pal '$(PALFILE_Visu1)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'E4.34' -L '' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu1) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard '$(AS_PROJECT_PATH)/Physical/Config2/X20cCP1301/VC/PS2-Keyboard.dis' -fp '$(AS_VC_PATH)/Firmware/V4.34.1/SG4' -prj '$(AS_PROJECT_PATH)' -apj 'LiquidControlOfTank' -sfas -vcob '$(VCOBJECT_Visu1)'
...
KEYMAP_SOURCES_Visu1=$(AS_PROJECT_PATH)/Physical/Config2/X20cCP1301/VC/PS2-Keyboard.dis 
...
BMINFO_SOURCES_Visu1=$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/AlphaPadQVGA1.bminfo \
	...
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Horizontal_pump_right.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pipe_60degree_angle1.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Reducer2.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Short_horizontal_pipe.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Tank_001.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_3D.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pipe_90degree_curve2.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pipe_90degree_curve3.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pump_Green.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pump_Red.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Green.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Red.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Red_Full.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pump_Green_gradient.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Green_gradient.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Red_gradient.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pump_Red_gradient.bminfo 
...
BMGRP_SOURCES_Visu1=$(AS_PROJECT_PATH)/Logical/Visu1/BitmapGroups/AlphaPadQVGA.bmgrp \
	...
	$(AS_PROJECT_PATH)/Logical/Visu1/BitmapGroups/ValveState.bmgrp \
	$(AS_PROJECT_PATH)/Logical/Visu1/BitmapGroups/PumpState.bmgrp 

PAGE_SOURCES_Visu1=$(AS_PROJECT_PATH)/Logical/Visu1/Pages/Init_Page.page \
	$(AS_PROJECT_PATH)/Logical/Visu1/Pages/Settings.page 

LAYER_SOURCES_Visu1=$(AS_PROJECT_PATH)/Logical/Visu1/Layers/ValveLayer.layer \
	$(AS_PROJECT_PATH)/Logical/Visu1/Layers/PumpLayer.layer 
...
$(TEMP_PATH_Visu1)/page.Settings.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Pages/Settings.page $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu1)/StyleSheets/Color.vcs' -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas
...
$(TEMP_PATH_Visu1)/layer.ValveLayer.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Layers/ValveLayer.layer $(VC_LANGUAGES_Visu1)
...
$(TEMP_PATH_Visu1)/layer.PumpLayer.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Layers/PumpLayer.layer $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1) -ds $(DEFAULT_STYLE_SHEET_Visu1) -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas
...
$(TEMP_PATH_Visu1)/tpr.NumPad.vco: $(AS_PROJECT_PATH)/Logical/Visu1/TouchPads/NumPad.tpr
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1) -prj 'C:/Projects/LiquidControlInTank/Logical/Visu1' -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas
...
$(TEMP_PATH_Visu1)/bmgrp.ValveState.vco: $(AS_PROJECT_PATH)/Logical/Visu1/BitmapGroups/ValveState.bmgrp
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bmgrp.PumpState.vco: $(AS_PROJECT_PATH)/Logical/Visu1/BitmapGroups/PumpState.bmgrp
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas
...
$(TEMP_PATH_Visu1)/bminfo.Horizontal_pump_right.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Horizontal_pump_right.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Horizontal_pump_right.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Pipe_60degree_angle1.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pipe_60degree_angle1.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pipe_60degree_angle1.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Reducer2.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Reducer2.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Reducer2.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Short_horizontal_pipe.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Short_horizontal_pipe.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Short_horizontal_pipe.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Tank_001.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Tank_001.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Tank_001.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Valve_3D.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_3D.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_3D.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Pipe_90degree_curve2.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pipe_90degree_curve2.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pipe_90degree_curve2.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Pipe_90degree_curve3.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pipe_90degree_curve3.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pipe_90degree_curve3.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Pump_Green.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pump_Green.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pump_Green.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Pump_Red.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pump_Red.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pump_Red.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Valve_Green.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Green.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Green.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Valve_Red.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Red.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Red.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Valve_Red_Full.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Red_Full.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Red_Full.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Pump_Green_gradient.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pump_Green_gradient.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pump_Green_gradient.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Valve_Green_gradient.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Green_gradient.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Green_gradient.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Valve_Red_gradient.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Red_gradient.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Valve_Red_gradient.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas


$(TEMP_PATH_Visu1)/bminfo.Pump_Red_gradient.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pump_Red_gradient.bminfo $(AS_PROJECT_PATH)/Logical/Visu1/Bitmaps/Pump_Red_gradient.gif
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4341 -sfas
...
vcPostBuild_Visu1 :
	$(VCC) -pb -vcm '$(TEMP_PATH_Visu1)/MODULEFILES.vcm' -fw '$(VCFIRMWAREPATH)' $(VCCFLAGS_Visu1) -p Visu1 -vcr 4341 -sfas
